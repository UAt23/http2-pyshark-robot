...
def capture_shark(pcap_file_path, streamid):
    ...
    # custom_filter_parameters = {"-Y": "tcp.port==8006 and http2.header.value == GET and http2.streamid=={}".format(streamid),
    #                             # "-O": "http2"
    #                             }
    # Sniff from interface
    capture = pyshark.FileCapture(pcap_file_path, decode_as={'tcp.port==8006':'http2', 'tcp.port==7000':'http2', 'tcp.port==5000':'http2'}, custom_parameters=custom_filter_parameters)
